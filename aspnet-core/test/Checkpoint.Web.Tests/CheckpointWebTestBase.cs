...
{
    public abstract class CheckpointWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CheckpointWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CheckpointWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CheckpointDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CheckpointDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CheckpointDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CheckpointDbContext, Task<T>> func)
        {
            T result;
